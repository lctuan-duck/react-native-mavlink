...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::mavlink::Coordinate> final {
    static inline margelo::nitro::mavlink::Coordinate fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::mavlink::Coordinate(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::mavlink::Coordinate& arg) {
