...
{
    ACTION_OPEN=0, /* Gripper commence open. Often used to release cargo. | */
    ACTION_CLOSE=1, /* Gripper commence close. Often used to grab onto cargo. | */
    ACTION_STOP=2, /* Gripper stop (maintain current grip position). | */
};
